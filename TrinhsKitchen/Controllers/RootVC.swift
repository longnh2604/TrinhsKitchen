...
//  TrinhsKitchen
//
//  Created by longnh on 2021/12/18.
//
...
class RootVC: AKSideMenu, AKSideMenuDelegate {
    ...
    override func awakeFromNib() {
        ...
        if let storyboard = self.storyboard {
            ...
            self.leftMenuViewController = storyboard.instantiateViewController(withIdentifier: "LeftSideMenuVC")
            self.rightMenuViewController = storyboard.instantiateViewController(withIdentifier: "RightSideMenuVC")
        }
    }
